...
def load_gesture_map():
    ...
    try:
        ...
        logging.error("[ViGEm] Error: gesture_map.json not found.")
    except json.JSONDecodeError:
        logging.error("[ViGEm] Error: gesture_map.json is not valid JSON.")
    except Exception as e:
        logging.error(f"[ViGEm] Error loading gesture map: {e}")
